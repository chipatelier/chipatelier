"""Tests for AI endpoint auth guards and LLM client smoke test.
...
Chat endpoint was wired to NDJSON streaming in Plan 03-03.
test_chat_returns_501 removed — see tests/ai/test_chat_routes.py.
